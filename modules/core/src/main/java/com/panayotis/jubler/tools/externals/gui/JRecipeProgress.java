...
public class JRecipeProgress extends JDialog implements RecipeMonitor {
    ...
    public void execute(JubFrame jubler, Recipe recipe, Map<String, String> values,
                        List<SubEntry> scope, Map<String, JubFrame> windowSelections, boolean replaceInCurrent) {
        Thread worker = new Thread(
                () -> RecipeExecutor.execute(jubler, recipe, values, scope, windowSelections, replaceInCurrent, this),
