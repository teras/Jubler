...
public interface DecoderInterface {
    ...
    public abstract boolean createAudioCache(AudioFile afile, CacheFile cfile, DecoderListener fback);

    public abstract void interruptAudioCache();

    public abstract void destroyAudioCache(CacheFile cache);

    public abstract AudioPreview getAudioPreview(CacheFile cache, double from, double to);

    public abstract Image getFrame(VideoFile video, double time);
