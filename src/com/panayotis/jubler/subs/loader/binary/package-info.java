 ...
 * attachement of the images qualifies it to be a binary format. The parsing
 ...
 * and it is done so to adapt to the complex format of data, such as files
 * with different blocks and each blocks contains values with different 
 * meaning. <br><br>
 ...
 * The parsing mechanism also generates several events in which the instances
 * of {@link com.panayotis.jubler.subs.loader.AbstractTextSubFormat}
 * can catch and transform and manipulate data.
 */
