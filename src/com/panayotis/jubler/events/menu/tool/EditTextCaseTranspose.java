...
import static com.panayotis.jubler.subs.CommonDef.word_boundary;
 ...
 */
public class EditTextCaseTranspose extends MenuAction {
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            jublerParent.fn.subTextChanged();
    ...
    private CaseAction nextCaseAction(String current_text) {
        ...
        if (is_lower) {
            ...
            if (is_upper) {
                ...
                if (is_to_lower) {
                    //System.out.println("to lower as single");
                    return CaseAction.TO_LOWER_CASE;
                } else {
                    //System.out.println("to first character upper");
    ...
    }//end private CaseAction nextCaseAction(String current_text)
    ...
    private String upperCaseFirstLetter(String old_word) {
        ...
        remaining_part =
                remaining_part.toLowerCase();
        //System.out.println("remaining part lower: " + remaining_part);
        new_word =
                first_letter.toUpperCase() + remaining_part;
        //System.out.println("mixed case word: " + new_word);
        return new_word;
...
}//end public class EditTextCaseTranspose extends MenuAction
