 ...
 */
public class PackingImageFilesToTiffAction extends MenuAction {
    ...
    private File[] getInputFiles() {
        ...
        if (in_filedialog.showOpenDialog(jublerParent) != JFileChooser.APPROVE_OPTION) {
            return null;
        }
    ...
    private File getOutputFile() {
        ...
        if (out_filedialog.showOpenDialog(jublerParent) != JFileChooser.APPROVE_OPTION) {
            return null;
        }
...
}//end public class PackingImageFilesToTiffAction extends MenuAction
