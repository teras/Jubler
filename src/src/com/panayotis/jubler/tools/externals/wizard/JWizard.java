...
public class JWizard extends JDialog {
    ...
    private void initComponents() {
        ...
        AutoB.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        AutoB.setMargin(new java.awt.Insets(0, 0, 0, 0));
        jPanel1.add(AutoB);

        AutoSel.add(ManualB);
        ManualB.setText(_("Manually browse for the executable"));
        ManualB.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        ...
        BrowseStatusL.setText(_("Invalid executable!"));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/wizard.jpg")));
