...
public class JStyleEditor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Italic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/italics.png")));
        Italic.setToolTipText(_("Italic"));
        Italic.addActionListener(formListener);

        jPanel3.add(Italic);

        Underline.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/underline.png")));
        Underline.setToolTipText(_("Underline"));
        Underline.addActionListener(formListener);

        jPanel3.add(Underline);

        Strike.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/strike.png")));
        ...
        AdvancedSelect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/tabclosed.png")));
        AdvancedSelect.setIconTextGap(10);
        AdvancedSelect.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/tabpressedup.png")));
        AdvancedSelect.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/tabopenup.png")));
