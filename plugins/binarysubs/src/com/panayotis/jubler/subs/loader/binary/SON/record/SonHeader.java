...
public class SonHeader implements SONPatternDef, Cloneable {
    ...
    public Object clone() {
        ...
        try {
            ...
            new_header.son_attribute = (son_attribute == null ? null : (SonSubtitleImageAttribute) son_attribute.clone());
    ...
    public void copyRecord(SonHeader o) {
        try {
            ...
            this.son_attribute = (o.son_attribute == null ? null : (SonSubtitleImageAttribute) o.son_attribute.clone());
