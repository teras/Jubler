...
public class SonHeader implements HeaderedTypeSubtitle, SONPatternDef {
    ...
    public String toString() {
        ...
        b.append(is_new ? subtitle_file.getParent() : image_directory).append(UNIX_NL);

        if (is_new) {
            display_area = new short[]{0, 0,
                        (short) (moptions.getVideoWidth() - 1),
                        (short) (moptions.getVideoHeight() - 1)
                    };

            display_area = short_array;
        }
